...
<div class="p-6 bg-gray-50/50 min-h-screen">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <a href="#" class="block bg-blue-50/50 border border-blue-100 rounded-2xl p-6 shadow-sm hover:shadow-md hover:-translate-y-1 hover:bg-blue-100/50 transition-all duration-300">
        ...
        <a href="{{ route('admin.pengajuan') }}" class="block bg-amber-50/50 border border-amber-100 rounded-2xl p-6 shadow-sm hover:shadow-md hover:-translate-y-1 hover:bg-amber-100/50 transition-all duration-300">
            <div class="flex justify-between items-start">
                <div>
