{{-- resources/views/mitra/produk/create.blade.php --}}
@extends('theme.default')
@section('title', 'Tambah Produk - BUMDes Patimban')
...
<div class="container-fluid px-6 py-8">
    <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-200 max-w-2xl mx-auto">
        ...
        <div class="mb-6 flex items-center justify-between">
            <h3 class="text-2xl font-bold text-slate-800">Tambah Produk Baru</h3>
        ...
        {{-- FORM --}}
        <form action="{{ route('mitra.produk.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <input
                    ...
                    placeholder="Contoh: Olahan Peyek Udang"
                    required
                >
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-xs font-bold text-slate-400 uppercase mb-1">Stok / Jumlah</label>
                    <input
                        type="number"
                        name="jumlah"
                        value="{{ old('jumlah') }}"
            ...
            {{-- Foto Produk --}}
            <div>
                <label class="block text-xs font-bold text-slate-400 uppercase mb-1">Foto Produk</label>
                <input
                    type="file"
                    name="gambar"
